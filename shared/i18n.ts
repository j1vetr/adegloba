...
export const translations: Record<'tr' | 'en' | 'ru', Translation> = {
  tr: {
    ...
    auth: {
      ...
      chooseShipOption: "Gemi seçiniz",
      loadingShipsText: "Gemiler yükleniyor...",
      loginNowButton: "Giriş yap",
      joinText: "Denizde güvenilir internet bağlantısı için sisteme katılın",
      createAccountButton: "Yeni Hesap Oluştur",
      systemAccessText: "Sistem erişimi için lütfen bilgilerinizi girin",
    ...
    packages: {
      ...
      addToCart: "Satın Al",
      adding: "İşleniyor...",
      addedToCart: "Ödemeye Yönlendiriliyorsunuz",
      addedToCartDesc: "Paket sepete eklendi, ödeme sayfasına yönlendiriliyorsunuz",
      error: "Hata",
    ...
    userGuide: {
      ...
      description: "AdeGloba Starlink sistemini nasıl kullanacağınızı adım adım öğrenin",
      backToPanel: "Panele Dön",
      stepsTitle: "6 Adımda Starlink Paketi Satın Alın",
      stepsSubtitle: "Sistemi ilk kez kullanıyorsanız aşağıdaki adımları takip ederek kolayca paket satın alabilirsiniz",
      instantActivation: "Anlık Aktivasyon",
      instantDesc: "Ödeme sonrası paketiniz anında aktif olur",
      globalCoverage: "Global Kapsama", 
      globalDesc: "Dünyanın her yerinde internet erişimi",
      securePayment: "Güvenli Ödeme",
      secureDesc: "PayPal ve SSL ile korumalı işlemler",
      support247: "7/24 Destek",
      supportDesc: "Her an ulaşabileceğiniz teknik destek",
      needHelp: "Hâlâ Yardıma İhtiyacınız Var mı?",
      needHelpDesc: "Herhangi bir adımda zorlanırsanız profesyonel destek ekibimiz size yardımcı olmaktan mutluluk duyar",
      createTicket: "Destek Talebi Oluştur",
      whatsappSupport: "WhatsApp Destek",
      step1Title: "Hesap Oluşturun ve Giriş Yapın",
      step1Desc: "AdeGloba Starlink sistemine kayıt olun ve güvenli giriş yapın",
      step1Detail1: "Ana sayfadan 'Kayıt Ol' butonuna tıklayın",
      step1Detail2: "E-posta adresinizi ve güçlü bir şifre belirleyin",
      step1Detail3: "Hesabınızı doğruladıktan sonra 'Giriş Yap' ile sisteme girin",
      step1Detail4: "Profil sayfasından kişisel bilgilerinizi tamamlayın",
      step1Button: "Giriş Yap",
      step2Title: "Paketleri İnceleyin",
      step2Desc: "Size uygun veri paketlerini keşfedin ve karşılaştırın",
      step2Detail1: "Müşteri panelinden 'Paketler' bölümüne gidin",
      step2Detail2: "Farklı veri limitlerini (50GB, 100GB, 200GB) inceleyin",
      step2Detail3: "Fiyatları ve paket özelliklerini karşılaştırın",
      step2Detail4: "İhtiyacınıza uygun paketi seçin",
      step2Button: "Paketleri Gör",
      step3Title: "Sepete Ekleme ve Satın Alma",
      step3Desc: "Seçtiğiniz paketleri sepete ekleyin ve güvenli ödeme yapın",
      step3Detail1: "Beğendiğiniz paketi 'Sepete Ekle' ile sepete atın",
      step3Detail2: "Sepet sayfasından paket detaylarını kontrol edin",
      step3Detail3: "Kupon kodunuz varsa uygulayın",
      step3Detail4: "PayPal veya kredi kartı ile güvenli ödeme yapın",
      step3Button: "Sepeti Gör",
      step4Title: "Ödeme ve Aktivasyon",
      step4Desc: "Ödemenizi tamamlayın ve paketinizi anında kullanmaya başlayın",
      step4Detail1: "Ödeme sayfasında bilgilerinizi güvenle girin",
      step4Detail2: "PayPal hesabınızla veya kredi kartınızla ödeme yapın",
      step4Detail3: "Ödeme onayından sonra paketiniz otomatik aktif olur",
      step4Detail4: "Giriş bilgileriniz e-posta ile gönderilir",
      step4Button: "Panel",
      step5Title: "Profil Yönetimi",
      step5Desc: "Kişisel bilgilerinizi güncelleyin ve hesabınızı yönetin",
      step5Detail1: "Müşteri panelinden 'Profil' sayfasına gidin",
      step5Detail2: "Ad, soyad ve iletişim bilgilerinizi güncelleyin",
      step5Detail3: "Şifrenizi değiştirmek için güvenlik ayarlarını kullanın",
      step5Detail4: "Hesap bilgilerinizi düzenli olarak kontrol edin",
      step5Button: "Profil",
      step6Title: "Destek Alma",
      step6Desc: "Sorunlarınız için profesyonel destek alın",
      step6Detail1: "Panelden 'Destek' bölümüne gidin",
      step6Detail2: "Yeni destek talebi oluşturun",
      step6Detail3: "Sorununuzu detaylı olarak açıklayın",
      step6Detail4: "WhatsApp destek hattından anlık yardım alın",
      step6Button: "Destek"
    },
  ...
  en: {
    ...
    packages: {
      ...
      addToCart: "Buy Now",
      adding: "Processing...",
      addedToCart: "Redirecting to Checkout",
      addedToCartDesc: "Package added, redirecting to checkout page",
      error: "Error",
    ...
    userGuide: {
      title: "User Guide",
      description: "Learn how to use the AdeGloba Starlink system step by step",
      backToPanel: "Back to Panel",
      stepsTitle: "Buy Starlink Package in 6 Steps",
      stepsSubtitle: "If you are using the system for the first time, you can easily buy a package by following the steps below",
      instantActivation: "Instant Activation",
      instantDesc: "Your package is activated immediately after payment",
      globalCoverage: "Global Coverage",
      globalDesc: "Internet access anywhere in the world",
      securePayment: "Secure Payment",
      secureDesc: "Protected transactions with PayPal and SSL",
      support247: "24/7 Support",
      supportDesc: "Technical support you can reach anytime",
      needHelp: "Still Need Help?",
      needHelpDesc: "If you have difficulty with any step, our professional support team will be happy to help you",
      createTicket: "Create Support Ticket",
      whatsappSupport: "WhatsApp Support",
      step1Title: "Create Account and Login",
      step1Desc: "Register to AdeGloba Starlink system and login securely",
      step1Detail1: "Click 'Register' button from the main page",
      step1Detail2: "Enter your email address and set a strong password",
      step1Detail3: "After verifying your account, login with 'Sign In'",
      step1Detail4: "Complete your personal information from profile page",
      step1Button: "Login",
      step2Title: "Browse Packages",
      step2Desc: "Discover and compare data packages that suit you",
      step2Detail1: "Go to 'Packages' section from customer panel",
      step2Detail2: "Review different data limits (50GB, 100GB, 200GB)",
      step2Detail3: "Compare prices and package features",
      step2Detail4: "Select the package that suits your needs",
      step2Button: "View Packages",
      step3Title: "Add to Cart and Purchase",
      step3Desc: "Add selected packages to cart and make secure payment",
      step3Detail1: "Add your favorite package to cart with 'Add to Cart'",
      step3Detail2: "Check package details from cart page",
      step3Detail3: "Apply coupon code if you have one",
      step3Detail4: "Make secure payment with PayPal or credit card",
      step3Button: "View Cart",
      step4Title: "Payment and Activation",
      step4Desc: "Complete your payment and start using your package instantly",
      step4Detail1: "Securely enter your information on payment page",
      step4Detail2: "Pay with your PayPal account or credit card",
      step4Detail3: "Your package is automatically activated after payment confirmation",
      step4Detail4: "Login credentials are sent via email",
      step4Button: "Panel",
      step5Title: "Profile Management",
      step5Desc: "Update your personal information and manage your account",
      step5Detail1: "Go to 'Profile' page from customer panel",
      step5Detail2: "Update your name, surname and contact information",
      step5Detail3: "Use security settings to change your password",
      step5Detail4: "Regularly check your account information",
      step5Button: "Profile",
      step6Title: "Get Support",
      step6Desc: "Get professional support for your problems",
      step6Detail1: "Go to 'Support' section from panel",
      step6Detail2: "Create a new support ticket",
      step6Detail3: "Describe your problem in detail",
      step6Detail4: "Get instant help from WhatsApp support line",
      step6Button: "Support"
    },
  ...
  ru: {
    ...
    packages: {
      ...
      addToCart: "Купить",
      adding: "Обработка...",
      addedToCart: "Переход к оплате",
      addedToCartDesc: "Пакет добавлен, переходим на страницу оплаты",
      error: "Ошибка",
    ...
    userGuide: {
      ...
      description: "Изучите как использовать систему AdeGloba Starlink пошагово",
      backToPanel: "Назад к панели",
      stepsTitle: "Купите пакет Starlink за 6 шагов",
      stepsSubtitle: "Если вы впервые используете систему, вы можете легко купить пакет, выполнив приведённые ниже шаги",
      instantActivation: "Мгновенная активация",
      instantDesc: "Ваш пакет активируется немедленно после оплаты",
      globalCoverage: "Глобальное покрытие",
      globalDesc: "Доступ к интернету в любой точке мира",
      securePayment: "Безопасная оплата",
      secureDesc: "Защищённые транзакции с PayPal и SSL",
      support247: "Поддержка 24/7",
      supportDesc: "Техническая поддержка, к которой можно обратиться в любое время",
      needHelp: "Нужна помощь?",
      needHelpDesc: "Если у вас возникли трудности на любом этапе, наша профессиональная команда поддержки с радостью вам поможет",
      createTicket: "Создать заявку на поддержку",
      whatsappSupport: "Поддержка WhatsApp",
      step1Title: "Создать аккаунт и войти",
      step1Desc: "Зарегистрируйтесь в системе AdeGloba Starlink и безопасно войдите",
      step1Detail1: "Нажмите кнопку 'Регистрация' на главной странице",
      step1Detail2: "Введите свой адрес электронной почты и установите надёжный пароль",
      step1Detail3: "После подтверждения аккаунта войдите через 'Войти'",
      step1Detail4: "Заполните личную информацию на странице профиля",
      step1Button: "Войти",
      step2Title: "Просмотр пакетов",
      step2Desc: "Найдите и сравните подходящие вам пакеты данных",
      step2Detail1: "Перейдите в раздел 'Пакеты' с панели клиента",
      step2Detail2: "Изучите различные лимиты данных (50ГБ, 100ГБ, 200ГБ)",
      step2Detail3: "Сравните цены и функции пакетов",
      step2Detail4: "Выберите пакет, который соответствует вашим потребностям",
      step2Button: "Посмотреть пакеты",
      step3Title: "Добавить в корзину и купить",
      step3Desc: "Добавьте выбранные пакеты в корзину и совершите безопасную оплату",
      step3Detail1: "Добавьте понравившийся пакет в корзину с помощью 'Добавить в корзину'",
      step3Detail2: "Проверьте детали пакета на странице корзины",
      step3Detail3: "Примените код купона, если он у вас есть",
      step3Detail4: "Оплатите безопасно через PayPal или кредитную карту",
      step3Button: "Посмотреть корзину",
      step4Title: "Оплата и активация",
      step4Desc: "Завершите оплату и начните использовать свой пакет немедленно",
      step4Detail1: "Безопасно введите свою информацию на странице оплаты",
      step4Detail2: "Оплатите через свой аккаунт PayPal или кредитную карту",
      step4Detail3: "Ваш пакет автоматически активируется после подтверждения оплаты",
      step4Detail4: "Данные для входа отправляются по электронной почте",
      step4Button: "Панель",
      step5Title: "Управление профилем",
      step5Desc: "Обновите личную информацию и управляйте своим аккаунтом",
      step5Detail1: "Перейдите на страницу 'Профиль' с панели клиента",
      step5Detail2: "Обновите свои имя, фамилию и контактную информацию",
      step5Detail3: "Используйте настройки безопасности для смены пароля",
      step5Detail4: "Регулярно проверяйте информацию о вашем аккаунте",
      step5Button: "Профиль",
      step6Title: "Получить поддержку",
      step6Desc: "Получите профессиональную поддержку по вашим проблемам",
      step6Detail1: "Перейдите в раздел 'Поддержка' с панели",
      step6Detail2: "Создайте новую заявку на поддержку",
      step6Detail3: "Опишите свою проблему подробно",
      step6Detail4: "Получите мгновенную помощь через линию поддержки WhatsApp",
      step6Button: "Поддержка"
    },
